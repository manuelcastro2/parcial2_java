                    ...
                    <c:forEach var="itema" items="${result.rows}">
                        <c:if test="${itema.cedula==itema.estudiante}">
                            ...
                            <p>
                                ...
                                <c:if test="${itema.estado_coordinador=='aprobado' && itema.estado_evaluador!=''}">
                            ...
                            <c:if test="${itema.estado_director=='aprobado'}">
                                <c:if test="${itema.estado_evaluador==''}">
                                    ...
                                    <form action="verevaluador.jsp" method="post">
                                        <input type="hidden" id="estu" name="estu" value="${itema.estudiante}">
                                        <input type="hidden" id="cedu" name="cedu" value="${resultado.rows[0].cedula}">
