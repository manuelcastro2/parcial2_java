            ...
            <div class="caja-delantera">
                    ...
                    <form method="post">
                        <c:forEach var="itema" items="${taller.rows}">
                            ...
                            <select id="cargo" name="cargo">
                                <option value="${itema.cargo}"><c:out value="${itema.cargo}" /> <-dato antiguo</option>
                ...
                <c:if test="${param.modificar !=null}">
                    <sql:update var="result" dataSource="${usuarios}">
                        update usuarios 
                        set cedula='${param.usuario}', nombre='${param.nombre}', apellido='${param.apellido}',cargo='${param.cargo}', password='${param.contrasena}'
